...
namespace Uween
{
    ...
    {
        public static T Add<T>(GameObject g, float duration) where T : TweenVec3, new()
        {
            return Tween.Get<T>(g, duration);
        }

        public static T Add<T>(GameObject g, float duration, Vector3 to) where T : TweenVec3, new()
        {
        ...
        public static T Add<T>(GameObject g, float duration, float x, float y, float z) where T : TweenVec3, new()
        {
