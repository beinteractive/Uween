...
namespace Uween
{
    ...
    {
        public static T Add<T>(GameObject g, float duration) where T : TweenVec1, new()
        {
            return Tween.Get<T>(g, duration);
        }

        public static T Add<T>(GameObject g, float duration, float to) where T : TweenVec1, new()
        {
